...
export default function Home() {
  return (
    <div className="mt-40">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-500  to-purple-400 ">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-center mb-4">Ready to Take Control of Your Finances?</h2>
          <p className="text-blue-100 mb-8 font-semibold max-w-2xl mx-auto">Join thousands of users who are already managing their finances smarter with FinGeniusAI</p>
          <Link href="/dashboard">
            <Button size="lg" className="bg-white/70 text-blue-800 hover:bg-blue-50 animate-bounce">
              Start Free Trial
            </Button>
          </Link>
        </div>
